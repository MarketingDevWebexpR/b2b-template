...
// src/client.ts
var BridgeApiClient = class extends BaseApiClient {
  dynamicHeaders = {};
  constructor(config) {
    super(config);
  }
...
function registerBridgeProvider() {
  registerProvider("bridge", (config) => {
...
export { BridgeCommerceClient, BridgeInventoryService, BridgeProductService, BridgeSyncService, createBridgeClient, mapBridgeCategory, mapBridgeProduct, mapBridgeProducts, registerBridgeProvider };
