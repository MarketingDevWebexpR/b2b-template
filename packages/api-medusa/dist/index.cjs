...
// src/client.ts
var MedusaApiClient = class extends apiCore.BaseApiClient {
  dynamicHeaders = {};
  constructor(config) {
    super(config);
  }
...
function registerMedusaProvider() {
  apiClient.registerProvider("medusa", (config) => {
...
exports.MedusaCartService = MedusaCartService;
exports.MedusaCommerceClient = MedusaCommerceClient;
exports.MedusaProductService = MedusaProductService;
exports.createMedusaClient = createMedusaClient;
exports.mapMedusaCart = mapMedusaCart;
exports.mapMedusaCategory = mapMedusaCategory;
exports.mapMedusaDiscount = mapMedusaDiscount;
exports.mapMedusaLineItem = mapMedusaLineItem;
exports.mapMedusaProduct = mapMedusaProduct;
exports.mapMedusaShippingOptions = mapMedusaShippingOptions;
exports.mapMedusaTotals = mapMedusaTotals;
exports.registerMedusaProvider = registerMedusaProvider;
