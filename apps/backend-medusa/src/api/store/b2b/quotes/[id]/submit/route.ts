/**
 * Store B2B Quote Submit API Route
 *
 * POST /store/b2b/quotes/:id/submit - Submit quote for seller review
 *
...
/**
 * POST /store/b2b/quotes/:id/submit
 *
 * Submits a draft quote for seller review.
 *
...
export async function POST(
  ...
  try {
    ...
    const updatedQuote = await quoteService.submitQuote(
      quoteId,
      customerId,
