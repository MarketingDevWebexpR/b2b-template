  ...
  return (
    <div className="mb-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-4">
        <div>
          {query ? (
            <h1 className="text-2xl font-semibold text-b2b-text-primary">
      ...
      {/* Toolbar */}
      <div className="flex flex-wrap items-center justify-between gap-3 py-3 px-4 bg-b2b-bg-secondary rounded-lg border border-b2b-border-light">
