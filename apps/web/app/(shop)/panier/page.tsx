      ...
      <section className="relative overflow-hidden bg-gradient-warm">
        ...
        <Container className="py-12 lg:py-16">
          <div className="text-center">
            ...
            <h1 className="font-sans text-heading-1 text-content-primary md:text-display-2 lg:text-display-1">
              Panier
            </h1>

            <div className="mx-auto my-6 h-px w-24 bg-primary" />

            <p className="mx-auto max-w-xl font-sans text-body-lg leading-elegant text-content-muted">
