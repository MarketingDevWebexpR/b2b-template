...
/**
 * Error state for Quote Detail Page
 *
 * Displayed when an error occurs during quote data fetching or rendering.
 * Provides options to retry or navigate back to the quotes list.
 */
export default function QuoteDetailError({ error, reset }: ErrorProps) {
  useEffect(() => {
    ...
    >
      <div className="text-center max-w-md">
        ...
        <p className="mt-4 font-sans text-body text-text-secondary">
          Impossible de charger les details du devis. Cela peut etre du a un probleme
