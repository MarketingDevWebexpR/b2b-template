...
interface OtherCollectionsProps {
  ...
  currentSlug: string;
  /** Maximum number of categories to display (default: 6) */
  maxDisplay?: number;
}
...
/**
 * CategoryCard - Text-only category card with elegant hover effects
 */
 ...
 * - Subtle hover effects with animated accent line
  ...
  return (
    <section className="border-t border-border-light bg-background-beige py-16 lg:py-24">
      <Container>
        ...
        >
          {otherCategories.slice(0, maxDisplay).map((category, index) => (
